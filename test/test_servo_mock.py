...
class TestClass:
    ...
    # def test_measure_200(self, requests_mock):
    ...
    # # 400
    # def test_adjust_400(self, requests_mock):
    #     self.fail_phase = 'ADJUST'
    ...
    # def test_measure_400(self, requests_mock):
    #     self.fail_phase = 'MEASURE'
    #     self.status_code = 400
    #     self.error_text = "Invalid input"
    #     requests_mock.register_uri(
    ...
    # # 503
    # def test_adjust_503(self, requests_mock):
    #     self.fail_phase = 'ADJUST'
    ...
    # def test_measure_503(self, requests_mock):
    #     self.fail_phase = 'MEASURE'
    #     self.status_code = 503
    #     self.error_text = "Unknown route"
    #     requests_mock.register_uri(
